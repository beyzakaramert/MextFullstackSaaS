...
namespace MextFullstackSaaS.Infrastructure.Migrations
{
    ...
    [Migration("20240528072533_mig_2")]
    partial class mig_2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MextFullstackSaaS.Domain.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "af0ab31d-e400-44ce-b791-fc81881e400a",
                            CreatedByUserId = "35c16d2a-f25b-4701-9a74-ea1fb7ed6d93",
                            CreatedOn = new DateTimeOffset(new DateTime(2024, 5, 22, 13, 16, 31, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEEXAKchjVdn0aRi26jdR48GaFCTHXHVo6I/KEHHYem2mjlciK5VGfTU+l5poLawSiw==",
